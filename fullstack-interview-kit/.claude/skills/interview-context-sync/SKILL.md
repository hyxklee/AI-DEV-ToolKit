...
| Test | `.interview-rules.md`, `.claude/skills/test-create/SKILL.md` |
| Debug | `prompts/03-debugging.md`, `.claude/skills/systematic-debugging/SKILL.md` |
| Review | `prompts/04-final-review.md`, `.claude/skills/code-review/SKILL.md` |
| DB | `.interview-rules.md`, `.claude/skills/database-manage/SKILL.md` |
